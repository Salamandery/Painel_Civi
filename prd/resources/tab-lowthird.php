...
echo "<th scope='col'>Rede Social</th>\n";
echo "<th scope='col'>Situa&ccedil;&atilde;o</th>\n";
echo "</tr>\n";
echo "</thead>\n";
echo "<tbody>\n";
$stid = pg_exec(pgdb('CLT'), $selectRede);
...
?>
    ...
    $("tr").click(function() {
		...
		document.getElementById("cd4").value = id;
		document.getElementById("chkAt4").checked = ativ;
        document.getElementById("ds4").value = ds;
